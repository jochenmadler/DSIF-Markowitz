...
class objFunction_noTrans(objFunction):
    def function(self, weights, optimizeProcedure):
        ...
        if optimizeProcedure.optimize_request.optimize_objective == "s":
            ...
            return - port_shr
        elif optimizeProcedure.optimize_request.optimize_objective == "v":
            if port_vol < optimizeProcedure.optimize_result.total_volatility:
                objFunction.save(optimizeProcedure, return_df, port_shr, port_return, port_vol, port_weights)
            return port_vol
        elif optimizeProcedure.optimize_request.optimize_objective == "r":
